...
export const ThemeConfigurator = () => {
  ...
  const { navType, sideNavTheme, navCollapsed, topNavColor, headerNavColor, locale, currentTheme, direction } =
    ...
    <>
      <div className="mb-5">
        ...
        <ListOption
          ...
          selector={<Switch disabled={isNavTop} checked={isCollapse} onChange={handleToggleCollapseNav} />}
          disabled={isNavTop}
        />
        ...
        <ListOption
          name="Direction:"
          selector={
            <Radio.Group size="small" onChange={e => handleDirectionChange(e.target.value)} value={direction}>
