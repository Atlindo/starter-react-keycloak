...
import {Button, Card, Switch, Table, Flex, Input, Space, InputNumber, Form, Menu, Select, Tag} from "antd";
import ApiService from "../../../../../services/api.service";
import {EditOutlined, EllipsisOutlined, FilterOutlined, SaveOutlined} from "@ant-design/icons";
...
export const Page = () => {
    ...
    const columns = [
        ...
        },
        {
            ...
            component: {
                render: (_) => {
                    return <Select mode={'multiple'} options={[
                        {
            ...
            render: (_) => {
                return Array.isArray(_) && _.length > 0 ? <div>
                    {_.map((child)=> {
                        return <Tag color={'cyan'} className={'mb-1'}>{child}</Tag>
                    })}
                </div> : null;
            },
            editable: true,
