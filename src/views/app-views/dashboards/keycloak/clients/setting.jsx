      ...
      KeycloakInterceptor.get(`/admin/realms/${keycloak?.realm}/clients/${uuid}`)
        .then(response => {
          ...
          form.setFieldsValue({
            ...
            authorizationServicesEnabled: !response?.data?.publicClient
              ? response?.data?.authorizationServicesEnabled
              : false,
              ...
              <Row gutter={[24, 24]}>
                <Col xs={24} xl={14} key="col-1">
                    ...
                    <Row gutter={[24, 12]}>
                      <Col xs={24} lg={12}>
                        <Form name="standardFlowEnabled">
                          <Checkbox defaultChecked={data?.standardFlowEnabled ?? false}>Standard Flow</Checkbox>
                        </Form>
                      </Col>
                      <Col xs={24} lg={12}>
                        <Form name="directAccessGrantsEnabled">
                          <Checkbox defaultChecked={data?.directAccessGrantsEnabled ?? false}>
                      ...
                      <Col xs={24} lg={12}>
                        <Form name={['attributes', 'oauth2.device.authorization.grant.enabled']}>
                          <Checkbox
                            defaultChecked={
                              data?.attributes['oauth2.device.authorization.grant.enabled'] === 'true' ?? false
                            }
                          >
                      ...
                      <Col xs={24} lg={12}>
                        <Form name={['attributes', 'oidc.ciba.grant.enabled']}>
                          <Checkbox
                            ...
                            defaultChecked={data?.attributes['oidc.ciba.grant.enabled'] === 'true' ?? false}
                          >
                            OIDC CIBA Grant
                          </Checkbox>
                        </Form>
                  ...
                  <Card title="Login Settings" loading={loading}>
                    <Form.Item name="rootUrl" label="Root URL">
                      <Input addonBefore={<GlobalOutlined />} placeholder="e.g https://domain.com" />
                    </Form.Item>
                    <Form.Item name="baseUrl" label="Home URL">
                      <Input addonBefore={<GlobalOutlined />} placeholder="e.g https://domain.com" />
                    </Form.Item>
